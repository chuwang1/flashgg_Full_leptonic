...
flashggHHWWggFLTag = cms.EDProducer("FlashggHHWWggFLTagProducer",
                                    ...
                                    doHHWWggFLTagCutFlowAnalysis = cms.bool(False), # save events for cut flow analysis                                      
...
# flashggHHWWggFLTagSequence = cms.Sequence( flashggHHWWggFLTag ) # not used 
