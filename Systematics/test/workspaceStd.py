...
customize.options.register('HHWWggFLTagsOnly',
                           False,
                           VarParsing.VarParsing.multiplicity.singleton,
                           VarParsing.VarParsing.varType.bool,
                           'HHWWggFLTagsOnly'
                           )
customize.options.register('doHHWWggFLTag',
                           False,
                           VarParsing.VarParsing.multiplicity.singleton,
                           VarParsing.VarParsing.varType.bool,
                           'doHHWWggFLTag'
                           )
customize.options.register('doHHWWggFLTagCutFlow', # This saves all events for cutflow analysis
                           False,
                           VarParsing.VarParsing.multiplicity.singleton,
                           VarParsing.VarParsing.varType.bool,
                           'doHHWWggFLTagCutFlow'
                           )
...
customize.options.register('doHHWWggNonResAnalysis', # If true and doing HHWWggFLTag, will apply non res analysis selections 
                           False,
                           VarParsing.VarParsing.multiplicity.singleton,
                           VarParsing.VarParsing.varType.bool,
...
if customize.tthTagsOnly or customize.HHWWggFLTagsOnly:
    ...
    if customize.HHWWggFLTagsOnly: # not sure if this is needed for tthTagsOnly, but it is needed for HHWWgg 
...
# if customize.HHWWggFLTagsOnly:
#     process.flashggTagSorter.TagPriorityRanges = cms.VPSet(     cms.PSet(TagName = cms.InputTag('flashggHHWWggFLTag')) )
...
if customize.doFiducial:
    ...
    print "taglist is:"
    print tagList
elif customize.HHWWggFLTagsOnly:
...
# HHWWggFLTagsOnly requires zeroeth vertex, but not modifySystematicsWorkflowForttH
if customize.tthTagsOnly or customize.HHWWggFLTagsOnly:
    #debug
...
# if customize.doHHWWggFLTag:
    # hhwwggc.HHWWggFLTagRunSequence(systlabels,jetsystlabels,phosystlabels)  
